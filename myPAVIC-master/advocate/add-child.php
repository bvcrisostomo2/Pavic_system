...
<html>
  <head>
    ...
    <title>Advocate Add Child - PAVIC</title>
  </head>
  <body>
    ...
    <div class="container">
      ...
      <div class="text-center">
        <h1>Welcome <?php echo $advocate_info['first_name']; ?>!</h1>
        <h2>Please fill up your child's info to proceed to your profile.</h2>
      </div>
      <?php } ?>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-9 tect-center">
