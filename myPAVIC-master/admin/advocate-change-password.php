...
<html>
  <head>
    ...
    <title>Change Advocate Password - PAVIC</title>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="advocates.php">Advocates</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"><a href="advocates.php">Advocate</a> / <a href="advocate-profile.php?advocate_id=<?php echo $_GET['advocate_id']; ?>">Advocate Profile</a> / Change Password</h1>
          ...
          <div class="row">
            <div class="col-xs-offset-3 col-xs-6">
              ...
              <form  class="" action="php/do_advocate_change_password.php" method="post" enctype="multipart/form-data">
                <input type="text" name="advocate_id" value="<?php echo $_GET['advocate_id'] ?>" hidden>
                <div class="panel panel-primary">
                  <div class="panel-body">
                    <div class="form-group">
                      <label for="current_password">Your Admin Password:</label>
                ...
                <div class="text-center">
                  ...
                  <a class="btn btn-danger bttn" href="advocate-profile.php?advocate_id=<?php echo $_GET['advocate_id']; ?>">Cancel</a>
                </div>
              </form>
            </div>
          </div>
