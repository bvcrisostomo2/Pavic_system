...
<html>
  <head>
    ...
    <title>Change Admin Password - PAVIC</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"><a href="administrators.php">Administrators</a> / Change Password</h1>
          ...
          <div class="row">
            <div class="col-xs-offset-3 col-xs-6">
              ...
              <form  class="" action="php/do_admin_change_password.php" method="post" enctype="multipart/form-data">
