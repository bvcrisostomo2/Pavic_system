...
<html>
  <head>
    ...
    <title>Unconfirmed Advocate Profile - PAVIC</title>
  ...
  <body cz-shortcut-listen="true">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"><a href="unconfirmed.php">Advocates</a> / Unconfirmed Advocate Profile</h1>
                        ...
                        <table class="table smaller-text">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <small><?php echo $advocate_info['region']; ?></small>
                              </td>
                            </tr>
                            <tr>
                              <th>
                  ...
                  <div class="col-md-7">
                    <div class="row panel panel-default">
                      <div class="col-md-12 panel-body yes-padding-bottom">
                        <h3>Children</h3>
                        <table id="unconfirmed_children_table" class="table dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            <tr>
    ...
    <?php include 'includes/unconfirmed_child_modal.php'; ?>
